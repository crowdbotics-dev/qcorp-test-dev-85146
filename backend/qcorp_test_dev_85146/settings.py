"""
Django settings for qcorp_test_dev_85146 project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', "work", "demo"
]
LOCAL_APPS = [
    'home',
...
ROOT_URLCONF = 'qcorp_test_dev_85146.urls'
...
WSGI_APPLICATION = 'qcorp_test_dev_85146.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qcorp_test_dev_85146 API",
    "DESCRIPTION": "API documentation for qcorp_test_dev_85146 App",
    "VERSION": "v1",
}
